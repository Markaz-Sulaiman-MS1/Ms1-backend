...
urlpatterns = [
    ...
    path("create-inventory-spare/", CreateInventoryStock.as_view(), name="create-inventory-stock"),
    path("list-inventory-spare/", ListInventoryStock.as_view(), name="list-inventory-stock"),
